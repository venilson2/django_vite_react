			...
			<Card>
				<CardBody className="p-0 auth-header-box">
					<div className="text-center p-3">
						...
						<p className="text-muted  mb-0">De volta ao painel do Fully Semse.</p>
					</div>
				</CardBody>
				<CardBody>
					<div className="ex-page-content text-center">
						<Image src={"/static/images/error.svg"} alt="error" className="" height="170" />
						<h1 className="mt-5 mb-4">404!</h1>
						<h5 className="font-16 text-muted mb-5">Algo deu errado</h5>
					</div>
					<Link
